...
pub struct Solver {
    map: Map,
    strategy: Strategy,
    lower_bounds: OnceCell<HashMap<Vector2, i32>>,
    tunnels: OnceCell<HashSet<(Vector2, Direction)>>,
}
...
impl Solver {
    ...
    pub fn lower_bounds(&self) -> &HashMap<Vector2, i32> {
    ...
    pub fn tunnels(&self) -> &HashSet<(Vector2, Direction)> {
    ...
    /// the nearest goal.
    fn calculate_minimum_push(&self) -> HashMap<Vector2, i32> {
    ...
    fn calculate_minimum_push_to(
        ...
        lower_bounds: &mut HashMap<Vector2, i32>,
        visited: &mut HashSet<(Vector2, Direction)>,
    ) {
    ...
    /// pre-calculated.
    fn calculate_tunnels(&self) -> HashSet<(Vector2, Direction)> {
