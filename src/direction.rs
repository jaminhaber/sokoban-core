...
impl From<Direction> for Vector2 {
    fn from(direction: Direction) -> Self {
        ...
        match direction {
            E::Up => -Vector2::unit_y(),
            E::Down => Vector2::unit_y(),
            E::Left => -Vector2::unit_x(),
            E::Right => Vector2::unit_x(),
        }
    }
}
...
impl TryFrom<Vector2> for Direction {
    ...
    fn try_from(vector: Vector2) -> Result<Self, Self::Error> {
        use Direction::*;
        match vector {
            v if v == -Vector2::unit_y() => Ok(Up),
            v if v == Vector2::unit_y() => Ok(Down),
            v if v == -Vector2::unit_x() => Ok(Left),
            v if v == Vector2::unit_x() => Ok(Right),
            _ => Err(()),
        }
    }
}
